...
{
    protected $fillable = ['enabled','oauth_token','client_login','campaign_id','feed_id','markup_percent','balance_reserve','sync_interval_minutes','campaign_bid_ceiling','default_bid_level','allowed_bid_levels','strategy_sync_status','strategy_synced_at','last_connection_check_at','last_sync_at','last_error'];
    protected $hidden = ['oauth_token'];
    protected $casts = ['enabled'=>'boolean','oauth_token'=>'encrypted','markup_percent'=>'decimal:2','balance_reserve'=>'decimal:2','campaign_bid_ceiling'=>'decimal:2','default_bid_level'=>'decimal:2','allowed_bid_levels'=>'array','strategy_synced_at'=>'datetime','last_connection_check_at'=>'datetime','last_sync_at'=>'datetime'];
