...
class UpdateSellerYandexBidModifierJob implements ShouldQueue, ShouldBeUnique
{
    ...
    public function handle(): void
    {
        ...
        if(!$settings->enabled||$settings->bid_ceiling_sync_status!=='synced'||(float)$settings->applied_bid_ceiling!==(float)$settings->desired_bid_ceiling||!$group?->ad_group_id)return;
        try {
